...
var RubiksCube = class {
  ...
  edgePermutation;
  // An array representing the position of each edge (0-11)
  edgeOrientation;
  // An array representing the orientation of each edge
  cornerPermutation;
  // An array representing the position of each corner (0-7)
  cornerOrientation;
  // An array representing the orientation of each corner (0-2)
  ...
  constructor() {
    ...
    this.edgeOrientation = Array(12).fill(true);
  ...
  isSolved() {
    return this.arraysEqual(this.edgeOrientation, this.solvedEdgeOrientation) && this.arraysEqual(this.cornerOrientation, this.solvedCornerOrientation) && this.arraysEqual(this.edgePermutation, this.solvedEdgePermutation) && this.arraysEqual(this.cornerPermutation, this.solvedCornerPermutation);
  }
  fbEoSovled() {
    return this.arraysEqual(this.edgeOrientation, this.solvedEdgeOrientation);
  }
  udDrSolved() {
    return this.arraysEqual(this.edgeOrientation, this.solvedEdgeOrientation) && this.arraysEqual(this.cornerOrientation, this.solvedCornerOrientation) && this.edgePermutation[4] > 3 && this.edgePermutation[4] < 8 && this.edgePermutation[5] > 3 && this.edgePermutation[5] < 8 && this.edgePermutation[6] > 3 && this.edgePermutation[6] < 8 && this.edgePermutation[7] > 3 && this.edgePermutation[7] < 8;
  }
  allOpposites() {
    return this.udDrSolved && this.cornerPermutation[0] % 2 === 0 && this.cornerPermutation[2] % 2 === 0 && this.cornerPermutation[4] % 2 === 0 && this.cornerPermutation[6] % 2 === 0 && this.cornerPermutation[1] % 2 === 1 && this.cornerPermutation[3] % 2 === 1 && this.cornerPermutation[5] % 2 === 1 && this.cornerPermutation[7] % 2 === 1 && (this.edgePermutation[0] === 0 || this.edgePermutation[0] === 2 || this.edgePermutation[0] === 8 || this.edgePermutation[0] === 10) && (this.edgePermutation[2] === 0 || this.edgePermutation[2] === 2 || this.edgePermutation[2] === 8 || this.edgePermutation[2] === 10) && (this.edgePermutation[8] === 0 || this.edgePermutation[8] === 2 || this.edgePermutation[8] === 8 || this.edgePermutation[8] === 10) && (this.edgePermutation[10] === 0 || this.edgePermutation[10] === 2 || this.edgePermutation[10] === 8 || this.edgePermutation[10] === 10) && (this.edgePermutation[1] === 1 || this.edgePermutation[1] === 3 || this.edgePermutation[1] === 9 || this.edgePermutation[1] === 11) && (this.edgePermutation[3] === 1 || this.edgePermutation[3] === 3 || this.edgePermutation[3] === 9 || this.edgePermutation[3] === 11) && (this.edgePermutation[9] === 1 || this.edgePermutation[9] === 3 || this.edgePermutation[9] === 9 || this.edgePermutation[9] === 11) && (this.edgePermutation[11] === 1 || this.edgePermutation[11] === 3 || this.edgePermutation[11] === 9 || this.edgePermutation[11] === 11);
  }
  ...
  areEqual(cube) {
    return this.arraysEqual(this.edgePermutation, cube.edgePermutation) && this.arraysEqual(this.edgeOrientation, cube.edgeOrientation) && this.arraysEqual(this.cornerPermutation, cube.cornerPermutation) && this.arraysEqual(this.cornerOrientation, cube.cornerOrientation);
  }
};
export {
  RubiksCube
